...
1. [Ссылки на облака с гайдами/прочим цифровым контентом](#Ссылки-на-фото-товарища-майора-без-погон-и-ордера)
...
2. [Софт для пека](#Основные-программы-для-защиты-пеки)
2. [Софт для телебонов](#Основные-программы-для-защиты-телебонов)
***
...
# Ссылки на фото товарища майора без погон и ордера
##### Софт на пекарню:  
