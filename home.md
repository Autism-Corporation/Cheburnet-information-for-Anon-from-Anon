...
1. После заполнения быстрого кэша в 256 МБ скорость записи снижается до 2-10 МБ/с (реальная скорость записи на жиск), когда данные из кэша запишутся на диск, кэш обнуляется и скорость взлетает до +400 МБ/с пока кэш не заполнится, и так по кругу.
