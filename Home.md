...
Для быстрого скачивания инфы рекомендую:скачать на рутрекере наборы IDE от JetBrains (качай все хуй знает что потом понадобиться), для примера возьму кожевенного питона PyCharm через настройки скачиваем все либы (в файлах либы должна быть документация), идём на гитхаб ставим поиск python и выкачиваем телепортом, потом идём на хабр и по такому же сценарию выкачиваем там статьи питона
