...
Суть проекта на самом деле в прощупывании почвы и распиле 20 миллиардов (пока положили в карман 1.8 лярда). 
##### Аргументы
...
>Слова Путина, сказанные во время прямой линии с перзидентом:
...
> Вкратце - специально, без причины изоляции не будет.
